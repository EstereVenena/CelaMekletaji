...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $parole       = $_POST["parole"] ?? "";
    $paroleRepeat = $_POST["parole_repeat"] ?? "";
    ...
    if (
    ...
    } elseif ($parole !== $paroleRepeat) {
        $error = "Paroles nesakrīt.";
    } elseif (mb_strlen($parole) < 6) {
        ...
        if ($checkStmt) {
            $checkStmt->bind_param("s", $formData["lietotajvards"]);
            $checkStmt->execute();
        ...
        if ($error === "") {
            ...
            if ($checkEmailStmt) {
                $checkEmailStmt->bind_param("s", $formData["epasts"]);
        ...
        if ($error === "") {
            ...
            if ($insertStmt) {
                ...
                $error = "Neizdevās sagatavot ievietošanas vaicājumu.";
            }
        }
    }
}
        ...
        <div class="form-shell">
            ...
            <section class="page-hero">
                <div>
                    ...
                    <p>Izveido jaunu lietotāja kontu administrēšanas sistēmā.</p>
                </div>
                ...
                <form method="POST">
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" id="parole" name="parole" class="form-control" required>
                        </div>

                        <div class="form-group">
                            <label for="parole_repeat">Atkārtot paroli *</label>
                            <input type="password" id="parole_repeat" name="parole_repeat" class="form-control" required>
                        </div>
                    </div>
